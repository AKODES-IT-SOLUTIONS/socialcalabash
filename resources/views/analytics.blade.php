...
<section class="home-2" style="background-image: url({{ asset('img/banner.png') }})">
   <div class="container">
      ...
      <div class="home-2-img" style="background-image: url({{ asset('img/analytics-1.png') }})">
   ...
   <div class="container">
      <div class="social-networks-item">
         <div class="social-networks-item-img">
            <img src="{{ asset('img/analytics-2.png') }}" alt="Analytics" />
         </div>
...
<section class="social-networks-2">
   <div class="container">
      <div class="social-networks-item">
         ...
         <div class="social-networks-item-img">
            <img src="{{ asset('img/analytics-3.png') }}" alt="Analytics" />
         </div>
      </div>
   </div>
</section>
<section class="social-networks-2 bg-white">
   <div class="container">
      <div class="social-networks-item">
         <div class="social-networks-item-img">
            <img src="{{ asset('img/analytics-4.png') }}" alt="Analytics" />
         </div>
         <div class="social-networks-item-text">
            <div class="social-networks-item-text-head">
...
<section class="social-networks-2">
   <div class="container">
      <div class="social-networks-item">
         ...
         <div class="social-networks-item-img">
            <img src="{{ asset('img/analytics-5.png') }}" alt="Analytics" />
         </div>
      </div>
   </div>
</section>
