...
<section class="home-2" style="background-image: url({{ asset('img/banner.png') }})">
   <div class="container">
      ...
      <div class="home-2-img" style="background-image: url({{ asset('img/stop-dashboard-home-img.png') }})">
   ...
   <div class="container">
      <div class="social-networks-item">
         <div class="social-networks-item-img">
            <img src="{{ asset('img/social-networks-2.png') }}" alt="Social Networks" />
         </div>
...
<section class="social-networks-2">
   <div class="container">
      <div class="social-networks-item">
         ...
         <div class="social-networks-item-img">
            <img src="{{ asset('img/social-networks-3.png') }}" alt="Social Networks" />
         </div>
      </div>
   </div>
</section>
<section class="social-networks-2 bg-white">
   <div class="container">
      <div class="social-networks-item">
         <div class="social-networks-item-img">
            <img src="{{ asset('img/social-networks-4.png') }}" alt="Social Networks" style="width: 60%;display: block;margin: auto;" />
         </div>
         <div class="social-networks-item-text">
            <div class="social-networks-item-text-head">
               <p>Auto updated</p>
