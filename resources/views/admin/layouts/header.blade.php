                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="row align-items-center">
                            ...
                            <!--Side Header Toggle-->
                            <div class="col-auto">
                                <button class="side-header-toggle"><i
                        ...
                        <ul class="header-notification-area">
                            ...
                            <li class="adomx-dropdown position-relative col-auto">
                                <a class="toggle" href="#"><img class="lang-flag"
                                                                src="{{ asset('admin/images/flags/flag-1.jpg') }}"
                                                                alt=""><i
                                        class="zmdi zmdi-caret-down drop-arrow"></i></a>

                                <!-- Dropdown -->
                                <ul class="adomx-dropdown-menu dropdown-menu-language">
                                    <li><a href="#"><img src="{{ asset('admin/images/flags/flag-1.jpg') }}" alt="">
                                            English</a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('admin/images/flags/flag-2.jpg') }}" alt="">
                                            Japanese</a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('admin/images/flags/flag-3.jpg') }}" alt="">
                                            Spanish </a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('admin/images/flags/flag-4.jpg') }}" alt="">
                                            Germany</a>
                                    </li>
                                </ul>
                            ...
                            <li class="adomx-dropdown col-auto">
                                <a class="toggle" href="#">
                                        <span class="user">
                                            ...
                                            <span
                                                class="name">@php echo Auth::guard('admin')->user()->name @endphp</span>
                                        </span>
                                </a>
                                ...
                                <div class="adomx-dropdown-menu dropdown-menu-user">
                                    <div class="head">
                                        <h5 class="name"><a
                                                href="#">{{ Auth::guard('admin')->user()->name }}</a></h5>
                                        <a class="mail"
                                           href="#">{{ Auth::guard('admin')->user()->email }}</a>
                                    </div>
                                    <div class="body">
                                        <ul>
                                            <li><a href="{{ route('admin.profile') }}"><i class="zmdi zmdi-account"></i>Profile</a>
                                            </li>
                                        </ul>
                                        <ul>
                                        ...
                                        <ul>
                                            <li><a href="{{ route('admin.logout')}}"><i class="zmdi zmdi-lock-open"></i>Sign
                                                    Out</a></li>
                                        </ul>
                                    </div>
                                </div>
