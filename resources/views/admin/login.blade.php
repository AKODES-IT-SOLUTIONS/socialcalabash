                                    ...
                                    <div class="row">
                                        ...
                                        {{--<div class="col-12">
                                            <div class="row justify-content-between">
                                                <div class="col-auto mb-15">Create a new account? <a href="{{ route('admin.register') }}">Register.</a></div>
                                            </div>
                                        </div>--}}
                                        <div class="col-12 mt-10"><button class="button button-primary button-outline">Login</button></div>
                                    </div>
                                </form>
