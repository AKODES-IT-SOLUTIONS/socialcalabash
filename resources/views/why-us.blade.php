...
<section class="home-2" style="background-image: url({{ asset('img/banner.png') }})">
   <div class="container">
      ...
      <div class="home-2-img" style="background-image: url({{ asset('img/why-us-1.png') }})">
   ...
   <div class="container">
      <div class="social-networks-item">
         <div class="social-networks-item-img">
            <img src="{{ asset('img/great-reports-2.png') }}" alt="Engage" />
         </div>
...
<section class="social-networks-2">
   <div class="container">
      <div class="social-networks-item">
         ...
         <div class="social-networks-item-img">
            <img src="{{ asset('img/why-us-2.png') }}" alt="Why Us" />
         </div>
      </div>
   </div>
</section>
<section class="social-networks-2 bg-white">
   <div class="container">
      <div class="social-networks-item">
         <div class="social-networks-item-img">
            <img src="{{ asset('img/why-us-3.png') }}" alt="Why Us" />
         </div>
         <div class="social-networks-item-text">
            <div class="social-networks-item-text-head">
               <p>Great value</p>
...
<section class="social-networks-2">
   <div class="container">
      <div class="social-networks-item">
         ...
         <div class="social-networks-item-img">
            <img src="{{ asset('img/why-us-4.png') }}" alt="Why Us" />
         </div>
      </div>
   </div>
</section>
