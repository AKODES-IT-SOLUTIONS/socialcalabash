        ...
        <div class="publish main">
            ...
            <div class="main-content">
                <div class="main-content-head">
                    <p>You haven't created any draft messages yet</p>
                </div>
                <div class="main-content-desc">
                    <p>Use the Compose button to quickly create new drafts that can be used later on.</p>
                </div>
                <div class="main-content-img">
                    <img src="{{ asset('dashboard/img/drafts-img.png') }}" alt="Drafts Image"/>
                </div>
            </div>
        </div>
    </div>
