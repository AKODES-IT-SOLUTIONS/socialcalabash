        ...
        <div class="monitor main">
            ...
            <div class="main-content">
                <div class="main-content-head">
                    <p>See what's happening on Twitter right now</p>
                </div>
                <div class="main-content-img">
                    <img src="{{ asset('dashboard/img/stats-img.png') }}" alt="Monitor Image">
                    <p>You don't have any previous Twitter searches. Use this box to start searching now.</p>
                </div>
            </div>
        </div>
    </div>
