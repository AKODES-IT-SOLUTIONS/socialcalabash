...
@section('title', 'Undelivered - Dashboard')
                        ...
                        <tbody id="page_list">
                            ...
                            @if ($social_posts->count() == 0)
                                <div class="main-content-head">
                                    <p>Your posts are being published successfully!</p>
                                </div>
                                <div class="main-content-desc">
                                    <p>From time to time, for reasons that are out of our control your posts may fail to publish
                                        successfully.</p>
                                </div>
                                <div class="main-content-img">
                                    <img src="{{ asset('dashboard/img/undelivered-img.png') }}" alt="undelivered Image"/>
                                    <p>Come back later to check if any of your posts failed to send and we'll help you correct the
                                        problem</p>
                                </div>
                            @else
                                @foreach ($social_posts as $key => $post)
                                    <tr style="border-bottom: 1px solid #707070;">
                                        ...
                                        <td style="border: none;">
                                          <span style="color: #d50808"><b>Failed</b></span>
                                        </td>

                                        <td style="border: none;">
                                            <form action="{{ route('user.retryFailedPosts') }}" method="post">
                                            @csrf
                                                <input type="hidden" value="{{ $post['id'] }}" name="post_id">
                                                <button type="submit" class="c-btn-blue" title="Retry">
