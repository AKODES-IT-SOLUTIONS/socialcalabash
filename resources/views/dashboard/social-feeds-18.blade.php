...
@section('title', 'Social Feeds-18 - Dashboard')
        ...
        <div class="social-feeds main">
            <div class="main-header">
                ...
                <div class="csv-search-filter">
                    <ul>
                        ...
                        <li>
                            <a href="#">All organizations <i class="fa fa-angle-down"></i></a>
                        </li>
            ...
            <div class="main-content">
                <div class="channels-checkboxes">
                    <form action="">
                        <label for=""><input type="checkbox" checked="checked"> demofbchannel 01</label>
                        <label for=""><input type="checkbox"> demofbchannel 02</label>
                        <label for=""><input type="checkbox"> demofbchannel 03</label>
                        <label for=""><input type="checkbox"> demofbchannel 04</label>
                    </form>
                </div>
                ...
                <div style="overflow-x: auto;">
                    <table>
                        <tr>
                            ...
                            <td>12:45 PM</td>
                            <td>
                                <p class="desc"><span class="blue-text">Brandon Sanders  </span>Fusce at nisi eget dolor
                                    rhoncus facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>12:45 PM</td>
                            <td>
                                <p class="desc"><span class="blue-text mx">Mary Barnett </span>Fusce at nisi eget dolor
                                    rhoncus facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>12:45 PM</td>
                            <td>
                                <p class="desc"><span class="blue-text mx">Jacob Hart </span>Fusce at nisi eget dolor
                                    rhoncus facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>12:45 PM</td>
                            <td>
                                <p class="desc"><span class="blue-text mx">Alex McDonald </span>Fusce at nisi eget dolor
                                    rhoncus facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>12:45 PM</td>
                            <td>
                                <p class="desc"><span class="blue-text mx">Rose Weber  </span>Fusce at nisi eget dolor
                                    rhoncus facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>12:45 PM</td>
                            <td>
                                <p class="desc"><span class="blue-text mx">Amanda Bailey </span>Fusce at nisi eget dolor
                                    rhoncus facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>12:45 PM</td>
                            <td>
                                <p class="desc"><span class="blue-text mx">Walter Grand </span>Fusce at nisi eget dolor
                                    rhoncus facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
