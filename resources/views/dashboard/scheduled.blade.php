...
@section('title', 'Scheduled - Dashboard')
                        ...
                        <tbody id="page_list">
                            ...
                            <div class="no-schedule">
                                ...
                                <div class="main-content-img">
                                    <img src="{{ asset('dashboard/img/scheduled-img.png') }}" alt="Scheduled Image"/>
                                </div>
                            </div>
                            @else
                                @foreach ($social_posts as $key => $post)
                                    <tr style="border-bottom: 1px solid #707070;">
                                        ...
                                        <td style="border: none;">
                                          <span style="color: #035ba7"><b>Scheduled ⏲️ </b></span>{!! date('d M, Y \a\t h:ia', strtotime($post['scheduled_datetime'])) !!}
                                        </td>
