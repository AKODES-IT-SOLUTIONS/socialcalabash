...
@section('title', 'Social Feeds-16 - Dashboard')
        ...
        <div class="social-feeds main">
            ...
            <div class="main-content">
                <div class="channels-checkboxes">
                    <form action="">
                        <label for=""><input type="checkbox"> demofbchannel 01</label>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="desc"><span class="red-text">Sent </span>Fusce at nisi eget dolor rhoncus
                                    facilisis. Mauris ante nisl, consectetur et luctus et, porta ut dolor.</p>
                                </p>
                            </td>
                            <td>
                                <a href="#"><img src="{{ asset('dashboard/img/delete-icon.png') }}" alt="Delete Icon"></a>
