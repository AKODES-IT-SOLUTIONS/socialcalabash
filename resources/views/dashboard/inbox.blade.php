        ...
        <div class="activity main">
            <div class="main-header">
                <div class="main-header-btns">
                    ...
                    <form action="">
                        <label for=""><input type="checkbox" name="check"> Archied only</label>
                    </form>
                </div>
                <div class="csv-search-filter">
                    <ul>
                        ...
                        <li><a href="#">Search by organization</a></li>
                    </ul>
                </div>
            </div>
            <div class="main-content">
                <div class="main-content-head">
                    <p>You have not yet received any new messages in your Priority Inbox</p>
                </div>
                <div class="main-content-img">
                    <img src="{{ asset('dashboard/img/inbox-img.png') }}" alt="Inbox Image">
                    <p>As you add more profiles, Sendible will keep track of your social accounts and
                        put all the important messages in one place - your Priority Inbox.</p>
                </div>
            </div>
        </div>
    </div>
