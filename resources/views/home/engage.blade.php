...
<section class="home-2" style="background-image: url('{{ asset('home/img/banner.png')}}');">
    <div class="container">
       ...
       <div class="home-2-img" style="background-image:url('{{asset('home/img/engage-1.png')}}');">
    ...
    <div class="container">
       <div class="social-networks-item">
          <div class="social-networks-item-img">
             <img src="{{asset('home/img/engage-2.png')}}" alt="Engage" />
          </div>
 ...
 <section class="social-networks-2">
    <div class="container">
       <div class="social-networks-item">
          ...
          <div class="social-networks-item-img">
             <img src="{{asset('home/img/engage-3.png')}}" alt="Engage" />
          </div>
       </div>
    </div>
 </section>
 <section class="social-networks-2 bg-white">
    <div class="container">
       <div class="social-networks-item">
          <div class="social-networks-item-img">
             <img src="{{asset('home/img/engage-4.png')}}" alt="Engage" />
          </div>
          <div class="social-networks-item-text">
             <div class="social-networks-item-text-head">
                <p>Alerts!</p>
