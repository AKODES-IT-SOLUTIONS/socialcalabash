...
<section class="home-2" style="background-image: url('{{ asset('home/img/banner.png')}}');">
    <div class="container">
       ...
       <div class="home-2-img" style="background-image: url('{{ asset('home/img/collaborate-1.png')}}');">
    ...
    <div class="container">
       <div class="social-networks-item">
          <div class="social-networks-item-img">
             <img src="{{asset('home/img/collaborate-2.png')}}" alt="Collaborate" />
          </div>
 ...
 <section class="social-networks-2">
    <div class="container">
       <div class="social-networks-item">
          ...
          <div class="social-networks-item-img">
             <img src="{{asset('home/img/collaborate-3.png')}}" alt="Collaborate" />
          </div>
       </div>
    </div>
 </section>
 <section class="social-networks-2 bg-white">
    <div class="container">
       <div class="social-networks-item">
          <div class="social-networks-item-img">
             <img src="{{asset('home/img/collaborate-4.png')}}" alt="Collaborate" />
          </div>
          <div class="social-networks-item-text">
             <div class="social-networks-item-text-head">
